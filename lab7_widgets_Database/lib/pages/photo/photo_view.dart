            ...
            actions: [
              model.viewType == PhotoViewType.list
                  ? IconButton(
                      ...
                      onPressed: () => model.viewType = PhotoViewType.search)
                  : SizedBox()
            ],
          ),
          body: Stack(
            children: [
              ...
              Visibility(
                visible:
                    model.viewType == PhotoViewType.search && !model.isBusy,
                child: Center(
                  child: Form(
                    key: _formKey,
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFormField(
                            decoration:
                                InputDecoration(hintText: 'Type a keyword'),
                            validator: (value) {
                              if (value.isEmpty) {
